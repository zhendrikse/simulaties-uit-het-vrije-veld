...
\title{Simulaties uit het Vrije Veld}  % Declares the document's title.
\author{Zeger W. Hendrikse}      % Declares the author's name.
% \date{January 21, 2025}      % Deleting this command produces today's date.
